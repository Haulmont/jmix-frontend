...
interface ICarEditComponentProps {
  screens: Screens;
}
...
@injectMainStore
@observer
class CarEditComponent extends React.Component<
  Props & WrappedComponentProps & ICarEditComponentProps
> {
...
const CarEdit = injectIntl(CarEditComponent);

export default observer(() => {
  const screens = React.useContext(ScreensContext);

  return <CarEdit screens={screens} />;
});
