...
>(
    ...
    }, [formWizardHelpersRef.current, formWizardHelpersRef.current.validateFields, entityEditorData.handleSubmit, entityEditorData.handleSubmitFailed, formWizardStore]);
