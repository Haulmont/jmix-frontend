...
import { Garage } from "../../jmix/entities/scr_Garage";
import { TechnicalCertificate } from "../../jmix/entities/scr_TechnicalCertificate";
...
class CarEdit2Component extends React.Component<Props & WrappedComponentProps> {
  ...
  isNewEntity = () => {
    return this.props.entityId === CarManagement2.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={CarManagement2.PATH} />;
    }
...
export default injectIntl(injectMainStore(observer(CarEdit2Component)));
