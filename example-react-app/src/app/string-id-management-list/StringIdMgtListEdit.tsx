...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === StringIdMgtListManagement.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={StringIdMgtListManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={StringIdMgtListManagement.PATH}>
