...
> {
  ...
  isNewEntity = () => {
    return this.props.entityId === WeirdStringIdMgtCardsManagement.NEW_SUBPATH;
  };
  ...
  render() {
    if (this.updated) {
      return <Redirect to={WeirdStringIdMgtCardsManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={WeirdStringIdMgtCardsManagement.PATH}>
