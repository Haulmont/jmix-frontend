...
describe('MultiScreenErrorBoundary', () => {
    let page;
    let $testsCard;
    const url = 'errorBoundaryTests';
    const errorBoundaryMessage = "Tab could not be loaded. Please refresh the page and try again.";
    ...
    beforeEach(async () => {
        ...
        $testsCard = await (await findByText($document, "Test screen level ErrorBoundary"))
