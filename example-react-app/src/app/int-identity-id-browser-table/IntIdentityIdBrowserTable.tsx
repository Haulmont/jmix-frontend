...
const ROUTING_PATH = "/intIdentityIdBrowserTable";
...
registerScreen({
  component: IntIdentityIdBrowserTable,
  caption: "intIdentityIdBrowserTable",
...
export default IntIdentityIdBrowserTable;
