...
const EXPECTED_I18N_KEYS = [
  ...
  "file.noFile",
  "hotkeys.hotkeyInfo.title",
  "hotkeys.hotkeyInfo.categoryName",
  "hotkeys.hotkeyInfo.toggleHotkeyInfo",
  "hotkeys.browserTable.categoryName",
  "hotkeys.browserTable.editEntity",
  "hotkeys.browserTable.createEntity",
  "hotkeys.browserTable.deleteEntity",
  "hotkeys.editor.categoryName",
  "hotkeys.editor.saveEntity",
  "hotkeys.tabs.categoryName",
  "hotkeys.tabs.nextTab",
  "hotkeys.tabs.previousTab",
  ...
  "jmix.dataTable.operator._eq",
  "jmix.dataTable.operator._neq",
  "jmix.dataTable.operator._gt",
  "jmix.dataTable.operator._gte",
  "jmix.dataTable.operator._lt",
  "jmix.dataTable.operator._lte",
  "jmix.dataTable.yes",
  "jmix.dataTable.no",
  "jmix.dataTable.ok",
  ...
  "jmix.entityFilter.selectFilter",
