...
export function setTheme(themePreset: ThemePreset) {
  ...
  (document.getElementById(idThemePresetLink) as HTMLLinkElement).href = getLinkHref(themePreset);
