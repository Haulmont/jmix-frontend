...
const AssociationM2OBrowse = observer(() => {
  ...
  const items = data?.scr_AssociationM2OTestEntityList;
  const total = data?.scr_AssociationM2OTestEntityCount;
