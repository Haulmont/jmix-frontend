...
interface IWeirdStringIdMgtCardsEditComponentProps {
  screens: Screens;
}
...
class WeirdStringIdMgtCardsEditComponent extends React.Component<
  Props & WrappedComponentProps & IWeirdStringIdMgtCardsEditComponentProps
> {
...
const WeirdStringIdMgtCardsEdit = injectIntl(
  injectMainStore(observer(WeirdStringIdMgtCardsEditComponent))
);

export default observer(() => {
  const screens = React.useContext(ScreensContext);

  return <WeirdStringIdMgtCardsEdit screens={screens} />;
});
