...
const Datatypes3Browse = observer((props: GenericEntityListProps) => {
  ...
  const itemsCount = count ?? data?.scr_DatatypesTestEntity3Count;
    ...
    >
      <Button
        ...
        onClick={deleteSelectedRow.bind(
          null,
          data?.scr_DatatypesTestEntity3List
        )}
        key="remove"
        type="default"
      >
