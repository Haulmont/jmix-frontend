...
interface IDatatypesEdit2ComponentProps {
  screens: Screens;
}
...
class DatatypesEdit2Component extends React.Component<
  Props & WrappedComponentProps & IDatatypesEdit2ComponentProps
> {
      ...
      <Card className="narrow-layout">
        ...
        >
          ...
          <Field
            ...
            /*parentEntityInstanceId={this.props.entityId !== DatatypesManagement2.NEW_SUBPATH ? this.props.entityId : undefined}*/
...
const DatatypesEdit2 = injectIntl(DatatypesEdit2Component);

export default observer(() => {
  const screens = React.useContext(ScreensContext);

  return <DatatypesEdit2 screens={screens} />;
});
