...
# [3.2.0-next.1](https://github.com/haulmont/jmix-frontend/tree/master/packages/jmix-server-mock/compare/@haulmont/jmix-server-mock@3.2.0-next.0...@haulmont/jmix-server-mock@3.2.0-next.1) (2022-02-04)


### Bug Fixes

* second and others entities are updating incorrectly using master-details screen [#942](https://github.com/haulmont/jmix-frontend/tree/master/packages/jmix-server-mock/issues/942) ([6692d8f](https://github.com/haulmont/jmix-frontend/tree/master/packages/jmix-server-mock/commit/6692d8f7eac1e29c58e9d75beff22db62b1bb9e4))
