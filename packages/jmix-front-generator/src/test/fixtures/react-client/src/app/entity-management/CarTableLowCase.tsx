...
const ROUTING_PATH = "/carTableLowCase";
...
const CarTableLowCase = observer((props: EntityListProps<Car>) => {
  const {
    entityList,
    onEntityListChange,
    onSelectEntity,
...
registerEntityList({
  component: CarTableLowCase,
  caption: "screen.CarTableLowCase",
  screenId: "CarTableLowCase",
  entityName: ENTITY_NAME,
  menuOptions: {
